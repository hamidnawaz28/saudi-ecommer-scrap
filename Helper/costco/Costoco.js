...
const COSTOCO = {
  async firstOne(query, filter, currentPage) {
    ...
    try {
      ...
      let url = `https://www.costco.com/CatalogSearch?currentPage=${currentPage}&dept=All&pageSize=24&sortBy=${filter}&keyword=${q}`;
      //   const proxy = `http://api.scraperapi.com?api_key=ba3b83fd02bf5da89a2dbd0cada33f29&url=${url}`;

      //   let url = "https://www.costco.com/";
      console.log("Url--------", url);
      await page.goto(url, {
        waitUntil: "load",
        timeout: 0,
